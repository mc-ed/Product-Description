    ...
    <div className="card">
      ...
      >
        <div className="card-body">
          ...
          <div className='bg-grey' style={{height: '60px', marginTop: '10px'}}>
            <select className='float-right' style={{height: '36px', margin: '10px'}} name="sortQuestions" id="sortQuestions">
          ...
          {props.questions.length ? <QuestionItem question={ props.questions[0] } /> :<div/>}
            </div>
          </div>
        </div>
      </div>
